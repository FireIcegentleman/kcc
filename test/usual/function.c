...
static void t2(int a) { expect(79, a); }
...
static void t9() { return; }

int t10(int a, double b) { return a + b; }

int ptrtest1() { return 55; }

int ptrtest2(int a) { return a * 2; }

float ptrtest3(float a) { return a * 2; }
...
int sum(MyType x) { return x.a + x.b + x.c + x.d; }

static void test_struct() { expect(14, sum((MyType){2, 3, 4, 5})); }

static void test_funcdesg() { test_funcdesg; }

typedef int (*t6_t)(void);

static t6_t retfunc() { return &t6; }

static t6_t retfunc2() { return t6; }
...
static pos_t get_pos(int column, int line) { return (pos_t){column, line}; }
...
static void array_func_param(int arr[]) { expect(8, sizeof(arr)); }

static void array_func_param_1(int arr[4]) { expect(8, sizeof(arr)); }
