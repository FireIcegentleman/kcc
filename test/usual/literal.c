...
static void test_string() {
  ...
  char expected[] = {65, 97, 7, 8,  12,  10, 13, 9,
                     11, 27, 7, 15, -99, -1, 18, 0};
...
static void test_mbstring() {
  ...
  expect(8, sizeof("ab"
                   u"c"));
  expect(8, sizeof(u"ab"
                   u"c"));
  expect(1, sizeof(u8""));
  expect(4, sizeof(u8"abc"));
  expect(4, sizeof("ab"
                   u8"c"));
  expect(4, sizeof(u8"ab"
                   u8"c"));
  expect(4, sizeof(L""));
  expect(16, sizeof(L"abc"));
  expect(16, sizeof(L"ab"
                    L"c"));
  expect(4, sizeof(U""));
  expect(16, sizeof(U"abc"));
  expect(16, sizeof("ab"
                    U"c"));
  expect(16, sizeof(U"ab"
                    U"c"));
  ...
  expect(12, sizeof("\u3042"
                    L"x"));
  expect(0, memcmp("\x42\x30\0\0\x78\0\0\0\0\0\0\0",
                   "\u3042"
                   L"x",
                   12));
...
} *g4 = &(struct g4){83, &(struct g4a){84, 85}};
